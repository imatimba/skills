...
Most userscript managers (Tampermonkey, Greasemonkey, Violentmonkey) compare versions segment by segment. Higher = newer.
...
1. The userscript manager fetches the @updateURL
